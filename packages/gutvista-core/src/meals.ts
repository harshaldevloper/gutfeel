...
export function buildDailyPlan(
  ...
  const slotsOfPlan = { breakfast: pickBest("breakfast", triggeredFoods), lunch: pickBest("lunch", triggeredFoods), dinner: pickBest("dinner", triggeredFoods) } as Record<MealSlot, MealOption>;
